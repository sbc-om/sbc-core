...
import { CreateContactDialog } from "../../contacts/_components/create-contact-dialog";
import { DeleteContactButton } from "../../contacts/_components/delete-contact-button";
...
export default async function SalesSettingsPage() {
  ...
  return (
    <SettingsSectionShell
      title="Sales"
      description="Manage customer-facing contacts from a dedicated settings section."
    >
      <section className="space-y-6 rounded-lg border border-border/70 bg-background p-6 shadow-sm lg:p-8">
        <div className="flex items-center justify-between gap-4">
          <div>
            <h2 className="text-xl font-semibold tracking-tight text-foreground">Contacts</h2>
